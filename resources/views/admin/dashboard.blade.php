                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Bob Doe's avatar"
                                                                     src="/admin/images/avatars/user.jpg"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Joe Doe's avatar"
                                                                     src="/admin/images/avatars/avatar2.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Jim Doe's avatar"
                                                                     src="/admin/images/avatars/avatar.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alex Doe's avatar"
                                                                     src="/admin/images/avatars/avatar5.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Susan's avatar"
                                                                     src="/admin/images/avatars/avatar3.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Phil Doe's avatar"
                                                                     src="/admin/images/avatars/avatar4.png"/>
                                                            </div>
                                                        ...
                                                        <div class="itemdiv memberdiv">
                                                            <div class="user">
                                                                <img alt="Alexa Doe's avatar"
                                                                     src="/admin/images/avatars/avatar1.png"/>
                                                            </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main no-padding">
                                            <div class="dialogs">
                                                ...
                                                <div class="itemdiv dialogdiv">
                                                    <div class="user">
                                                        <img alt="Bob's Avatar" src="/admin/images/avatars/user.jpg"/>
                                                    </div>
...
<script src="/admin/js/jquery.sparkline.index.min.js"></script>
