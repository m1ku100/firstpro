...
<head>
    ...
    <!-- text fonts -->
    <link rel="stylesheet" href="/admin/css/fonts.googleapis.com.css"/>

    <!-- ace styles -->
    <link rel="stylesheet" href="/admin/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style"/>

    <!--[if lte IE 9]>
    <link rel="stylesheet" href="/admin/css/ace-part2.min.css" class="ace-main-stylesheet"/>
    <![endif]-->
            ...
            <ul class="nav ace-nav">
                            ...
                            <ul class="dropdown-menu dropdown-navbar">
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="/admin/images/avatars/avatar.png" class="msg-photo"
                                             alt="Alex's Avatar"/>
												<span class="msg-body">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="/admin/images/avatars/avatar3.png" class="msg-photo"
                                             alt="Susan's Avatar"/>
												<span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="/admin/images/avatars/avatar4.png" class="msg-photo"
                                             alt="Bob's Avatar"/>
												<span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="/admin/images/avatars/avatar2.png" class="msg-photo"
                                             alt="Kate's Avatar"/>
												<span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="/admin/images/avatars/avatar5.png" class="msg-photo"
                                             alt="Fred's Avatar"/>
												<span class="msg-body">
													<span class="msg-title">
                ...
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="/admin/images/avatars/user.jpg" alt="Jason's Photo"/>
                            ...
                            <div class="col-xs-12">
                                <table id="simple-table" class="table  table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>Deskripsi</th>
                                        <th>Jumlah Kamar Total</th>
                                        <th>Jumlah Kamar Terisi</th>
                                        <th>Pemilik Kos</th>
                                        <th>No. Pemilik Kos</th>
                                        <th>Alamat</th>
                                        <th>Kota</th>
                                        <th>Action</th>
                                    </tr>
                                    ...
                                    @foreach($dataList as $view)
                                        ...
                                        <tr>
                                            ...
                                            <td><img style="height: 60px;width: 80px;"
                                                     src="/img/{{ $view->foto_kos_depan }}"></td>
                                            <td><img style="height: 60px;width: 80px"
                                                     src="/img/{{ $view->foto_kos_kamar }}"></td>
                                            <td>{{ $view->jenis_kos }}</td>
                                            <td>{{ $view->harga_per_bulan }}</td>
                                            <td>{{ $view->deskripsi }}</td>
                                            <td>{{ $view->jumlah_kamar_total }}</td>
                                            <td>{{ $view->jumlah_kamar_terisi }}</td>
                                            <td>{{ $view->pemilik_kos }}</td>
                                            <td>{{ $view->nomor_pemilik_kos }}</td>
                                            <td>{{ $view->alamat }}</td>
                                            <td>{{ $view->kota }}</td>
                                            <td>
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    <a href="{{url('admin/table/edit-'.$view->id)}}">
                                                        <button class="btn btn-xs btn-info">
                                                            <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                        </button>
                                                    </a>

                                                    <a onclick="return confirm('Apakah anda yakin untuk menghapus {{$view->nama_kos}} ?')"
                                                       href="{{url('admin/table/delete-'.$view->id)}}">
